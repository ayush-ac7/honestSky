  ...
  return error ? (
    ...
    <div className="p-6 px-2 md:px-0  flex items-center justify-center dark:bg-gray-900 ">
      <div className="shadow-2xl p-2 w-auto">
        ...
        <div className="*location & date* flex items-center justify-between gap-2 md:gap-8 mt-2">
          ...
          <h4 className="border-black border-l-[1px] md:border-l-0 pl-4 md:pl-0 text-sm md:text-base dark:border-white dark:text-white text-center">
        ...
        <div className="flex justify-between gap-4 md:gap-8 dark:text-white">
          <div className="rightSide-weatherInfo ">
            ...
            <p className="border-gray-100 dark:border-b-[1px] border-b-2 py-4">
              ...
              <span className="ml-12 md:ml-28">
                {/* unit conversion from second to km/h */}
          ...
          <div className="leftSide-weatherInfo">
